...
@ListenerFor(sourceClass = ShowcaseMenu.class, systemEventClass = PostAddToViewEvent.class)
public class ShowcaseMenu extends AbstractMenu implements Widget {

    public static final String COMPONENT_TYPE = "org.primefaces.component.ShowcaseMenu";
    public static final String COMPONENT_FAMILY = "org.primefaces.component";
    private static final String DEFAULT_RENDERER = "org.primefaces.component.ShowcaseMenuRenderer";
